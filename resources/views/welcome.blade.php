                                    ...
                                    <div class="flex items-center gap-2 pt-2 border-t border-gray-50">
                                        ...
                                        @else
                                            ...
                                            <button
                                                ...
                                                class="ml-auto bg-red-600 hover:bg-red-700 active:scale-95 text-white text-[11px] font-bold px-3 h-7 rounded-lg flex items-center gap-1 shadow-sm hover:shadow-md transition-all duration-200 shrink-0"
                                            >
