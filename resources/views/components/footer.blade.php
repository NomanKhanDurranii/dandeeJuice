    ...
    <div class="max-w-6xl mx-auto px-4 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div class="lg:col-span-1 space-y-4">
            ...
            <a href="https://wa.me/{{ $whatsapp }}"
               target="_blank"
               class="inline-flex items-center gap-2 bg-white hover:bg-gray-100 text-green-800 text-sm font-semibold px-4 py-2.5 rounded-xl transition shadow-md">
        ...
        <div>
            ...
            <div class="flex items-center gap-2 text-white/70 text-xs mt-2">
